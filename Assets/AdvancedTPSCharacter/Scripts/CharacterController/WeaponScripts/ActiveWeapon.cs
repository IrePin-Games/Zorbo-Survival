...
public class ActiveWeapon : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            if (GetComponent<ZorboCharacterMovement>().state == CharacterState.Vehicle) { return; }
        ...
        Controls.Keyboard.Shoot.started += ctx =>
         {
                if(GetComponent<ZorboCharacterMovement>().state == CharacterState.Vehicle) { return; }
                GetComponent<ZorboCharacterMovement>().IsRunning = false;
                GetComponent<ZorboCharacterMovement>().IsCrouching = false;
                GetComponent<ZorboCharacterMovement>().IsWalking = false;
                var controller = FindObjectOfType<UIController>();
                if (controller.CancelAllMovement == true) { return; }
                ...
                if (currentWeapon != null && !HolsteredWeapon)
                {
                    ...
                    {
                     if(GetComponent<ZorboCharacterMovement>().Crouched == true) { return; }
