...
public class CarCheck : MonoBehaviour
{
    ...
    public void EnterVehicle()
    {
        ...
        CarController carController = CurrentVehicle.GetComponent<CarController>();
            ...
            GetComponentInParent<ZorboCharacterMovement>().EnterCar();
            GetComponentInParent<ZorboCharacterMovement>().transform.parent.transform.parent = carController.CarExitTransform;
    }
    public void ExitVehicle()
    {
        ...
        CarController carController = CurrentVehicle.GetComponent<CarController>();
            ...
            GetComponentInParent<ZorboCharacterMovement>().ExitCar();
            GetComponentInParent<ZorboCharacterMovement>().transform.parent.transform.parent = null;
    }
}
