...
public class FootstepSound : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if(GetComponentInParent<ZorboCharacterMovement>().IsWalking == true)
        {
            StartWalkingFootsteps();
        }
        if (GetComponentInParent<ZorboCharacterMovement>().IsRunning== true)
        {
            StartRunningFootsteps();
        }
        if (GetComponentInParent<ZorboCharacterMovement>().IsCrouching == true)
        {
